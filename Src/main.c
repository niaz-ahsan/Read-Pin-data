...
void turn_on_LED(uint32_t *const RCC_AHB1, uint32_t *const GPIO_D_mode, uint32_t *const GPIO_D_output_data) {
...
void turn_off_LED(uint32_t *const GPIO_D_output_data) {
...
int main(void)
{
	uint32_t *const GPIO_D_mode = (uint32_t*) 0x40020C00; // GPIO D Mode Register Address
	uint32_t *const GPIO_D_output_data = (uint32_t*) 0x40020C14; // GPIO D O/P Data Register Address

	// enable RCC AHB1 peripheral reset register for GPIO A
	uint32_t *const RCC_AHB1 = (uint32_t*) 0x40023830;
	*RCC_AHB1 |= (1 << 0); // enabling 0th bit for GPIO A

	// GPIO A port mode register address
	uint32_t *const GPIOA_port_mode_reg = (uint32_t*) 0x40020000;
	...
	*GPIOA_port_mode_reg &= ~(3 << 0);
	...
	uint32_t *const GPIOA_input_data_reg = (uint32_t*) 0x40020010;
